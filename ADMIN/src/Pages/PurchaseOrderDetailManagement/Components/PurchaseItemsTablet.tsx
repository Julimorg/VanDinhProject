...
const POItemsTable: React.FC<POItemsTableProps> = ({ items }) => {
    ...
    },
    {
      ...
      render: (_, row) => (
        <div className="flex flex-col gap-0.5">
          <span className="font-semibold text-gray-800 text-sm leading-tight">{row.productName}</span>
  ...
  return (
    <>
      ...
      <AddProductModal
        ...
        onConfirm={(newItems) => {
          // TODO: gọi API thêm sản phẩm vào phiếu
          console.log("Submit items:", newItems);
          setModalOpen(false);
        }}
      />
    </>
