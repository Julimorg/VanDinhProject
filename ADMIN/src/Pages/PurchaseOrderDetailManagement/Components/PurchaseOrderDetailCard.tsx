...
import {
  ...
  InboxOutlined, DollarOutlined, FileTextOutlined,
...
interface POInfoCardsProps {
  data: IGetPurchaseOrderDetailResponse;
}
  ...
  <div className="flex flex-col gap-4">
    ...
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
      ...
      <StatCard
        ...
        label="Ngày tạo"
        value={formatDateTime(data.createAt)}
        bg="#F8FAFC"
        valueColor="#64748B"
      />
    </div>
...
const StatCard: React.FC<{
  ...
  bg: string;
  valueColor?: string;
}> = ({ icon, label, value, bg, valueColor = "#1E293B" }) => (
  <div
